...
attachedServices:
  comms-factory:
    ...
    image:
      ...
      tag: 21d335869190bbba107f1c52263acfeb20e0963a
      pullPolicy: IfNotPresent
    service:
      port: 8080
    secretEnv:
...
`tools/comms_factory` and the attached service source must be built from the
reviewed `infinex-dev/comms-factory` PR source. The current PR head is
`21d335869190bbba107f1c52263acfeb20e0963a`, based on
`3a01b3337692c64133185560b66706a28b703c4e`; update to the accepted merge commit
when that PR lands.
